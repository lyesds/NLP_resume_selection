...
for i in range(32,50):
    ...
    job_names.to_csv(r'to_delete_0{}.csv'.format(value),sep=',', index=False, mode='w')

# #get the job experience to string to find the ADJ
# job_extracted = job_names[0].to_string()
# job_extracted = ''.join([i for i in job_extracted if not i.isdigit()])
# import re
# job_extracted = re.sub(' +', ' ',job_extracted)

# doc = nlp(job_extracted)
